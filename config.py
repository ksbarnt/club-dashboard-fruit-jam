...
def _get_season_id(key):
    """A season id is optional and 0/absent both mean "not configured"."""
    season_id = _get_number(key, None, lambda v: int(float(v)))
...
class Config(object):
    ...
    def __init__(self):
        ...
        self.viqrc_season_id = _get_season_id("VIQRC_SEASON_ID")
        self.v5rc_season_id = _get_season_id("V5RC_SEASON_ID")
